This folder contains the results of `npm ls` and the full `node_modules` folder (as npm built it on my Mac OS X machine).

For convenience, the results of `npm ls` are also inlined below.

```
eslint-8547@0.1.0 /Users/cmoesel/dev/eslint_8547/eslint-8547
├─┬ eslint@3.19.0
